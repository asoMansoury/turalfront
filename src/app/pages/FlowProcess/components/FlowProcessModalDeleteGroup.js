...
function FlowProcessModalDeleteGroup(props) {
    ...
    const deleteBtn = () => {
        ...
        axios.put(FlowProcessRemoveByIds, { ids: input })
            .then(res => {
                notifySuccess();
                props.deletedGroup();
            })
...
export default connect(mapStateToProps, mapDispatchToProps)(checkRequests(FlowProcessModalDeleteGroup,axios));