...
import { Is_deleted_group } from '../_redux/Actions/costCategoryActions';
import { connect } from "react-redux";
import { API_URL, toastConfig } from '../Config';
import {CostCategoryRemoveByIds} from '../commonConstants/ApiConstants'
import axios from 'axios';
import toast from 'react-hot-toast';
import checkRequests from '../component/ErrroHandling';
function CostCategoryModalDeleteGroup(props) {
    ...
    const deleteBtn = () => {
        ...
        axios.put(CostCategoryRemoveByIds, { ids: input })
            .then(res => {
                notifySuccess();
                props.deletedGroup();
            }).catch((error)=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(checkRequests(CostCategoryModalDeleteGroup,axios));