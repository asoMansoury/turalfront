      ...
      controllerPersmission!=undefined&&actionsPermission!=undefined?
        ...
        <div className={classes.actions}>
          {numSelected > 0 ? (
           ...
           actionsPermission.find(z=>z.id==48)!==undefined? <CategoryModalDeleteGroup selected={props.selected} />:<></>
          )
            :
            (actionsPermission.find(z=>z.id==47)!==undefined?<Button onClick={addCategoryShow} className='btn-height2 create-btn' variant="info">افزودن دسته بندی</Button>:<></>)}
        </div>
        </Toolbar>
      :<></>
    }
      ...
      <div className={classes.root}>
        <ThemeProvider theme={theme}>
          <Paper className={classes.paper}>
            ...
            {
              actionsPermission.find(z=>z.id==45)!==undefined?
                        ...
                        <>
                          ...
                          >
                            ...
                            <TableCell className={classes.cell_short} align="center">
                              ...
                              <div style={{ display: !isLoading ? 'block' : 'none' }}>
                                {
                                  actionsPermission.find(z=>z.id==44)!==undefined?
                                ...
                                {
                                actionsPermission.find(z=>z.id==42||z.id===48)!==undefined?
...
export default connect(mapStateToProps, mapDispatchToProps)(checkRequests(EnhancedTable,axios));